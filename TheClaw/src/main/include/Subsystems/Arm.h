...
public:
	...
	static constexpr double POS1 = 0; // low or cargo pickup position

	static constexpr double POS2 = 0; //middle delivery spot

	static constexpr double POS3 = 0; // only used to deliver level one hatches
