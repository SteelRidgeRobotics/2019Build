...
public:
	...
	static constexpr double POS1 = 2050.0; // low or cargo pickup position

	static constexpr double POS2 = 3650.0; //middle delivery spot

	static constexpr double POS3 = 4215.0; // only used to deliver level one hatches

	static constexpr double POS4 = 5440.0;

	static constexpr double MIN = 0.0;

	static constexpr double MAX = 0;

	static constexpr double kF = 2.0;
