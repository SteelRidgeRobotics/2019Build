...
public:
	...
	static constexpr double HPOSLOW = 2050.0; // for the low and mid hatches

	static constexpr double HPOSHIGH = 4000.0; //for the high hatches

	static constexpr double CPOSLOW = 3600.0; //for the low and mid cargos



	static constexpr double CPOSHIGH = 5415.0; //for the high cargos

	static constexpr double MIN = 0.0;

	static constexpr double MAX = 0;

	static constexpr double kF = 1023.0/600.0;
