...
OI::OI() {
    ...
    rJoyBn->WhenPressed(new ClawPunch());
    lJoyBn.reset(new frc::JoystickButton(systemsController.get(), 9));
    lJoyBn->WhenPressed(new ClawClose());
...
*/
   ...
   dY.reset(new frc::JoystickButton(driveController.get(), 4));
   dX.reset(new frc::JoystickButton(driveController.get(), 3));

   dY->WhenPressed(new ElevatorUp(10000));
   dX->WhenPressed(new ArmUp(3000));
