...
Elevator::Elevator() : frc::Subsystem("Elevator") {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
     ...
     elevatorMotor->ConfigForwardLimitSwitchSource(RemoteLimitSwitchSource_RemoteTalonSRX, LimitSwitchNormal_NormallyOpen, 4, kTimeoutMS);
     elevatorMotor->ConfigReverseLimitSwitchSource(RemoteLimitSwitchSource_RemoteTalonSRX, LimitSwitchNormal_NormallyOpen, 4, kTimeoutMS);
...
{
    return rotations/kGearRatio/kSensorUnitsPerRotation; //... we need to figure out how to convert rotations into inches to do this conversion
}
