...
std::shared_ptr<WPI_TalonSRX> Robot::driveTrainLeftFront;
std::shared_ptr<WPI_TalonSRX> Robot::driveTrainLeftBack;
std::shared_ptr<WPI_TalonSRX> Robot::driveTrainRightFront;
std::shared_ptr<WPI_TalonSRX> Robot::driveTrainRightBack;
