...
/*
    driveSelect.reset(new frc::JoystickButton(driveController.get(), 7));
    driveSelect->WhileHeld(new HabSkiForward());
    driveStart.reset(new frc::JoystickButton(driveController.get(), 8));
    driveStart->WhileHeld(new HabSkiBack());
*/
